...
This project is indexed by GitNexus as **home-flow** (572 symbols, 891 relationships, 31 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
